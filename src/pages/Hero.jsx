...
const Hero = () => {
  return (
    <section className="w-screen h-screen bg-background flex flex-col sm:flex-row items-center justify-center">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex ">
        <div className="flex-[3] px-12 flex flex-col justify-center">
          <h1 className="md:text-6xl text-3xl text-primary font-bold">
            Hi I'm{" "}
